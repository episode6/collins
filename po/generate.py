...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "hu": {
        ...
        "Unhide project": "Projekt felfedése",
        "Hide project": "Projekt elrejtése",
    ...
    "de": {
        ...
        "Unhide project": "Projekt einblenden",
        "Hide project": "Projekt ausblenden",
    ...
    "fr": {
        ...
        "Unhide project": "Afficher le projet",
