...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "hu": {
        ...
        "Extra usage: {used} of {limit}": "Extra használat: {used} / {limit}",
    ...
    "de": {
        ...
        "Extra usage: {used} of {limit}": "Zusätzliche Nutzung: {used} von {limit}",
    ...
    "es": {
        ...
        "Extra usage: {used} of {limit}": "Uso adicional: {used} de {limit}",
    ...
    "fr": {
        ...
        "Extra usage: {used} of {limit}": "Utilisation supplémentaire : {used} sur {limit}",
