...
- **Preferences regrouped** — eighteen groups become nine. **General**
  opens the page with the CLI path, language, color scheme, status icon,
  tab drag handles, the sidebar's switches and the icon model; **Session
